...
g++ -std=c++11 -c Main.cpp Vecteur.cpp Objet.cpp CorpsStellaire.cpp Vaisseau.cpp Data.cpp
g++ -std=c++11 Main.o Objet.o Vecteur.o CorpsStellaire.o Vaisseau.o Data.o -o sfml-app -lsfml-graphics -lsfml-window -lsfml-system
